...
const names = books
  ...
  .sort((firstBookAuthor, secondBookAuthor) =>
    firstBookAuthor.localeCompare(secondBookAuthor)
  );

// // Тоже самое, но сортировка по названию книг
// const names = books
//   .filter((book) => book.rating >= MIN_BOOK_RATING)
//   .map((book) => book.title)
//   .sort((firstBookTitle, secondBookTitle) =>
//     firstBookTitle.localeCompare(secondBookTitle)
//   );
